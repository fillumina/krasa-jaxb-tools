...
- `2.3.8` add `multiPattern` option (false by default) to enable writing multiple `@Pattern` annotation instead of using `@Pattern.List` (thanks to [CrEaK (Niklas Neesen)](https://github.com/CrEaK))
